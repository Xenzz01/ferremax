from fastapi import APIRouter, FastAPI, HTTPException, Header, status
...
# DB connection
db = client["Ferremas"] # type: ignore
...
@app_router.get("/productos", response_model=List[Producto])
...
@app_router.post("/productos/{sucursalid}", response_model=Producto)
def create_producto(
    sucursalid: int,
    ...
    try:
        ...
        return Producto(**created_product) # type: ignore
...
@app_router.post("/productos/inventario/{sucursalid}", response_model=Producto)
def create_inventario(
    ...
    try:
        ...
        return Producto(**updated_product) # type: ignore
...
@app_router.put("/productos/{sucursalid}/{productoid}", response_model=Producto)
...
@app_router.delete("/productos/{productoid}")
def delete_producto(
    productoid: str,
    adminpassword: Annotated[str, Header(description="Contraseña de administrador general")],
):
